...
print("var_controlModulation2     = %s" % (opts.controlModulation))
...
print("var_controlCoding2         = %s" % (opts.controlCoding))
...
for i in range(0, opts.reps):
    if i % 20 == 0:
        sim = OFDMSim(controlCarriers = np.array(opts.controlCarriers), controlCarriers2 = np.array(opts.controlCarriers2),
                ...
                controlModulation2=opts.controlModulation,
                data=[],
                ...
                controlCoding2=opts.controlCoding)
        gc.collect()
